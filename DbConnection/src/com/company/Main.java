...
import com.company.kz.aitu.oop.practice.assignment4.data1.Postgredb;
import com.company.kz.aitu.oop.practice.assignment4.data1.interfaces.IDB1;
import com.company.kz.aitu.oop.practice.assignment4.repositories.EmployeesRepository;
...
//        }
        ...
        EmployeeFortEnd app = new EmployeeFortEnd(employeesRepository, projectsRepository);
        app.start();
    }
}